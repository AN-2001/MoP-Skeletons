...
Public Class SphareCreatorGrasshopperComponent
    ...
    ''' </summary>
    Public Sub New()
        MyBase.New("SphareCreatorGrasshopper", "SCHCSArch", _
                "Construct an Archimedean, or arithmetic, spiral given its radii and number of turns.", _
                "CSArch", "Primitives")
    End Sub
    ...
    Public Overrides ReadOnly Property ComponentGuid() As Guid
        Get
            Return New Guid("204c2fef-80a0-4ecc-b05b-a767e8d4975d")
        End Get
    End Property
End Class