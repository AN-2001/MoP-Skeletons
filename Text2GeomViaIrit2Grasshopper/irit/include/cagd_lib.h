...
CagdPolygonStruct *CagdSrf2Polygons(
				const CagdSrfStruct *Srf,
				struct CagdSrf2PlsInfoStrct * const AuxInfo);
...
CagdPolygonStruct *CagdSrfAdap2Polygons(
				const CagdSrfStruct *Srf,
				VoidPtr AuxSrfData,
				struct CagdSrf2PlsInfoStrct* const AuxInfo);
CagdPolygonStruct *CagdSrf2PolygonsGenPolys(
				const CagdSrfStruct *Srf,
				CagdRType *PtWeights,
				CagdPtStruct *PtMesh,
				...
				int FineNessV, 
				struct CagdSrf2PlsInfoStrct* const AuxInfo);
CagdPolygonStruct *CagdSrfAdapRectPolyGen(
			 const CagdSrfStruct *Srf,
			 CagdSrfPtStruct *SrfPtList,
			 const CagdSrfAdapRectStruct *Rect,
			 const struct CagdSrf2PlsInfoStrct * const AuxInfo);
...
CagdBType BzrSrf2PolygonsSamplesNuNv(const CagdSrfStruct *Srf,
				     ...
				     CagdVecStruct **PtNrml,
				     CagdUVStruct **UVMesh);
CagdPolygonStruct *BzrSrf2Polygons(
			        const CagdSrfStruct *Srf,
			        struct CagdSrf2PlsInfoStrct* const AuxInfo);
...
CagdSrfErrorFuncType BspSrf2PolygonSetErrFunc(CagdSrfErrorFuncType Func,
					      void *Data);
CagdPolygonStruct *BspSrf2Polygons(
				const CagdSrfStruct *Srf,
				struct CagdSrf2PlsInfoStrct * const AuxInfo);
