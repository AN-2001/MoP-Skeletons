...
int IGInitSrfTextureFromImage(IPObjectStruct *PObj,
			      int SrfIdx,
			      void *Image,
			      int ImageWidth,
			      int ImageHeight,
			      int ImageAlpha);
int IGDeleteTexture(IPObjectStruct *PObj);
...
IPObjectStruct *IGDecomposeMdlDue2Graphics(IPObjectStruct *PMdls);
...
IPObjectStruct *IGDecomposeVMdlDue2Graphics(IPObjectStruct *PVMdls);
