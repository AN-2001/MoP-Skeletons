...
#endif
#define  IRIT_COPYRIGHT	"(C) Copyright 1989-2020 Gershon Elber, Technion"
...
/* #undef DEBUG_IRIT_MALLOC  -   to disable debugging of mall/free in DEBUG */
...
typedef	IrtRType	IrtMinMaxType[2];		     /* For 2 reals. */
...
typedef long long	IritIntPtrSizeType;
#elif defined(__WINNT__)
typedef intptr_t	IritIntPtrSizeType;
#else
typedef long int	IritIntPtrSizeType;
#endif /* LINUX386 || SUN4 */
...
#define IRIT_LINE_LEN_MAX_CFG	20000
...
#define IRIT_GEN_MOVE(Dest, Src, Size) memmove((char *) (Dest), (char *) (Src), \
					       Size) /* If Dest & Src overlap.*/
...
#define IRIT_PT_APX_EQ_E4_EPS(Pt1, Pt2, Eps) \
			     (IRIT_APX_EQ_EPS((Pt1)[0], (Pt2)[0], (Eps)) && \
			      IRIT_APX_EQ_EPS((Pt1)[1], (Pt2)[1], (Eps)) && \
			      IRIT_APX_EQ_EPS((Pt1)[2], (Pt2)[2], (Eps)) && \
			      IRIT_APX_EQ_EPS((Pt1)[3], (Pt2)[3], (Eps)))
#define IRIT_PT_APX_EQ_E4(Pt1, Pt2)  IRIT_PT_APX_EQ_E4_EPS(Pt1, Pt2, IRIT_EPS)

#define IRIT_PT4D_DIST_SQR(Pt1, Pt2)  (IRIT_SQR((Pt1)[0] - (Pt2)[0]) + \
				       IRIT_SQR((Pt1)[1] - (Pt2)[1]) + \
				       IRIT_SQR((Pt1)[2] - (Pt2)[2]) + \
				       IRIT_SQR((Pt1)[3] - (Pt2)[3]))
#define IRIT_PT4D_DIST(Pt1, Pt2)      sqrt(IRIT_PT4D_DIST_SQR(Pt1, Pt2))
...
#define IRIT_PT_PT_DIST_SQR(Pt1, Pt2) (IRIT_SQR((Pt1)[0] - (Pt2)[0]) + \
				       IRIT_SQR((Pt1)[1] - (Pt2)[1]) + \
				       IRIT_SQR((Pt1)[2] - (Pt2)[2]))
#define IRIT_PT_PT_DIST(Pt1, Pt2)    sqrt(IRIT_PT_PT_DIST_SQR(Pt1, Pt2))
...
#define IRIT_PT2D_DIST_SQR(Pt1, Pt2) (IRIT_SQR((Pt1)[0] - (Pt2)[0]) + \
				      IRIT_SQR((Pt1)[1] - (Pt2)[1]))
#define IRIT_PT2D_DIST(Pt1, Pt2)  sqrt(IRIT_PT2D_DIST_SQR(Pt1, Pt2))
