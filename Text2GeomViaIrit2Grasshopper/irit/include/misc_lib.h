...
int IritImgPrcssSetPixelVal(IritImgPrcssImgStruct *Image,
			    ...
			    unsigned int j,
			    const float color[4]); 
IritImgPrcssImgStruct *IritImgPrcssToGrayScale(IritImgPrcssImgStruct *Image);
void IritImgPrcssDeleteImg(IritImgPrcssImgStruct *Image);
IritImgPrcssImgStruct *IritImgPrcssConv3(IritImgPrcssImgStruct *Image,
					 float Filter[9]);
IritImgPrcssImgStruct *IritImgPrcssSharpen(IritImgPrcssImgStruct *Image);
IritImgPrcssImgStruct *IritImgPrcssBiSobel(IritImgPrcssImgStruct *Image);
IritImgPrcssImgStruct *IritImgPrcssGaussianBlur(IritImgPrcssImgStruct *Image);
IritImgPrcssImgStruct *IritImgPrcssGaussianBlurMult(
						 IritImgPrcssImgStruct *Image,
						 int Amount);
IritImgPrcssImgStruct *IritImgPrcssInvert(IritImgPrcssImgStruct *Image);
IritImgPrcssImgStruct *IritImgPrcssDetectEdges(IritImgPrcssImgStruct *Image,
					       int BlurAmount);
