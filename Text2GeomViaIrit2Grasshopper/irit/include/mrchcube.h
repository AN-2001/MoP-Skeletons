...
typedef struct MCImprovePointOnIsoSrfInfoStruct
		                         *MCImprovePointOnIsoSrfInfoStructPtr;
...
MCImprovePointOnIsoSrfInfoStructPtr MCImprovePointOnIsoSrfPrelude(
					           const TrivTVStruct *TV);
void MCImprovePointOnIsoSrfPostlude(MCImprovePointOnIsoSrfInfoStructPtr
					                MCImprovePointOnI);
int MCImprovePointOnIsoSrf(MCImprovePointOnIsoSrfInfoStructPtr
			                                 MCImprovePointOnI,
			   IrtPtType Pt,
