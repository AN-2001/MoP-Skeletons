...
typedef struct MvarZeroPrblmExternalCBStruct {
    ...
    /* Allows in-place mapping of solutions from MV solver paramteric space */
    /* to actual solution sapce, typically Euclidean.			    */
    ...
    /* paramteric space to actual solution sapce, typically Euclidean.      */
...
struct IPObjectStruct *MvarCrvDiameter(const CagdCrvStruct *Crv,
				       CagdRType SubEps,
				       CagdRType NumEps);
struct IPObjectStruct *MvarCrvKernelPoint(const CagdCrvStruct *Crv,
					  CagdRType SubEps,
					  int OneKernelPoint,
...
CagdCrvStruct *MvarIsCrvOnSrf(const CagdCrvStruct *Crv,
			      ...
			      void *SrfPrepHandle,
			      CagdBType GenUVCrv);
MvarPolylineStruct *MvarIsCrvOnSrf1(const CagdCrvStruct *Crv1,
				    const CagdSrfStruct *Srf2,
				    int Axes,
				    CagdRType Step, 
				    CagdRType SubdivTol,
