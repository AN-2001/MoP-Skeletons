...
/******************************************************************************
* Fillets using Trivariates.						      *
******************************************************************************/
TrivTVStruct *TrivTVFillet(const CagdSrfStruct *Srf1,
		           const CagdSrfStruct *Srf2,
			   CagdRType RailDist,
			   int R1Orient,
			   int R2Orient,
			   CagdRType TanScale,
                           ...
                           CagdRType Tol,
                           CagdRType NumerTol,
			   CagdSrfStruct **BzrSubSrfs1,
			   CagdSrfStruct **UVSubSrfs1,
			   CagdSrfStruct **BzrSubSrf2,
			   CagdSrfStruct **UVSubSrfs2);
