...
#define VMDL_BLEND_NO_VALUE		IRIT_INFNTY
...
typedef void (*VMdlVModelBoolOpCBFuncType)(const struct VMdlVModelStruct *,
					   const struct VMdlVModelStruct *,
					   struct VMdlVModelStruct *,
					   VMdlBoolOpType,
					   void *AuxData);
...
typedef struct VMdlBlendOutputImageStruct {
    void **Points;
} VMdlBlendOutputImageStruct;
...
VMdlVModelStruct *VMdlPrimBoxVMdl(CagdRType MinX,
				  ...
				  CagdRType MaxY,
				  CagdRType MaxZ);
VMdlVModelStruct *VMdlPrimBoxVMdlExtra(const VMdlParamsStruct *Params,
				       CagdRType MinX,
				       CagdRType MinY,
				       CagdRType MinZ,
				       CagdRType MaxX,
...
VMdlVModelStruct *VMdlPrimCubeSphereVMdlExtra(const VMdlParamsStruct *Params,
...
VMdlVModelStruct *VMdlPrimTorusVMdl(const CagdVType Center,
				    ...
				    CagdBType Rational,
				    CagdRType InternalCubeEdge);
VMdlVModelStruct *VMdlPrimTorusVMdlExtra(const VMdlParamsStruct *Params,
					 const CagdVType Center,
					 CagdRType MajorRadius,
					 CagdRType MinorRadius,
					 CagdBType Rational,
...
VMdlVModelStruct *VMdlPrimConeVMdl(const CagdVType Center,
				   ...
				   CagdBType Rational,
				   CagdRType InternalCubeEdge);
VMdlVModelStruct *VMdlPrimConeVMdlExtra(const VMdlParamsStruct *Params,
					const CagdVType Center,
					CagdRType Radius,
					CagdRType Height,
					CagdBType Rational,
...
VMdlVModelStruct *VMdlPrimCone2VMdl(const CagdVType Center,
				    ...
				    CagdBType Rational,
				    CagdRType InternalCubeEdge);
VMdlVModelStruct *VMdlPrimCone2VMdlExtra(const VMdlParamsStruct *Params,
					 const CagdVType Center,
					 CagdRType MajorRadius,
					 CagdRType MinorRadius,
					 CagdRType Height,
...
VMdlVModelStruct *VMdlPrimCylinderVMdl(const CagdVType Center,
				       ...
				       CagdBType Rational,
				       CagdRType InternalCubeEdge);
VMdlVModelStruct *VMdlPrimCylinderVMdlExtra(const VMdlParamsStruct *Params,
					    const CagdVType Center,
					    CagdRType Radius,
					    CagdRType Height,
					    CagdBType Rational,
...
VMdlBlendOutputImageStruct *VMdlBlendPropertiesSlice(
				    VMdlBlendPrepStruct *BlendCoordPrep,
				    const double z,
				    int Resolution[2],
				    VMdlBlendCoordinatesFuncType Coordinates,
...
void VMdlBlendSaveImage(VMdlBlendOutputImageStruct *Image,
                        const char *Output,
...
void VMdlBlendOutputImageFree(VMdlBlendOutputImageStruct *Item,
                              const int SizeImage);
...
void VMdlBlendVElemComputeDistCoordinates(VMdlBlendPrepStruct
                                                               *BlendCoordPrep,
                                             const CagdRType Pt[3]);
VMdlBlendOutputImageStruct *VMdlBlendVCellPropertiesSlice(
                                           VMdlBlendPrepStruct *BlendCoordPrep,
                                           const double z,
                                           const int *Resolution);
VMdlBlendPropertyStruct VMdlBlendVCellPropertiesPerPoint(VMdlBlendPrepStruct
                                                               *BlendCoordPrep,
                                                         IrtRType Pt[3]);
...
void *VMdlBlendFilletPropertiesPerPoint(
				    ...
				    VMdlBlendCoordinatesFuncType Coordinates,
				    VMdlBlendPropertyFuncType PropertyFunction);
VMdlBlendOutputImageStruct *VMdlBlendFilletPropertiesSlice(
				    const VMdlParamsStruct *Params,
                                    VMdlBlendPrepStruct *BlendCoordPrep,
				    const double z,
				    int Resolution[2],
...
void VMdlCreateFillet(const TrivTVStruct *TV1,
                      const TrivTVStruct *TV2,
                      TrivTVBndryType Bndry1,
                      TrivTVBndryType Bndry2,
                      CagdRType RailDist,
                      int R1Orient,
                      int R2Orient,
                      CagdRType TanScale,
